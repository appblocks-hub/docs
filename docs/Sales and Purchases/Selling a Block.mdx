...
Through Spaces with [Manage Blocks](https://docs.appblocks.com/docs/Tracking%20your%20Sales%20and%20Orders#manage-blocks)  <!-- Insert ss -->
   * Choose own blocks tab from the table and find your block.
   * Make sure you have [deployed the block](https://github.com/appblocks-hub/docs/blob/blocks-store-updates/docs/Getting%20Started/Using%20the%20purchased%20block.mdx#deploying-the-app). 
