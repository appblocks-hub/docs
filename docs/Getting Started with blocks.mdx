...
Installing WSL
1.	Open windows Powershell or Command Prompt in administrator mode
2.	Run wsl –install
This will install and setup all the things necessary to run linux, including the latest ubuntu distro
For futher reading: https://learn.microsoft.com/en-us/windows/wsl/install
![gitt](https://user-images.githubusercontent.com/97872852/203749101-a6915fec-cb28-4d01-9a3e-fc85533eea11.gif)
Setup Ubuntu
1.	Open ubuntu from start, a terminal window will appear, where you can set the username and password for the linux user
![git1](https://user-images.githubusercontent.com/97872852/203754998-6b5c3e72-56a2-46b3-b8a9-ce14db3ec661.gif)
Install Terminal
1.	Visit windows store and search for Terminal.
2.	Install the first suggestion
![git2](https://user-images.githubusercontent.com/97872852/203755290-dcb464d2-98fa-4152-b2b7-055d2c11f96f.gif)
Change default profile
1.	Windows terminal by default will be set to open in powershell, you can shange that to use ubuntu profile by default.
For further reading: https://learn.microsoft.com/en-us/windows/terminal
![git3](https://user-images.githubusercontent.com/97872852/203755570-fc9eb24a-2339-4d13-9dc1-4d70dcfc0f8e.gif)
Install nvm
1.	It is recommended to use nvm for installing node.
2.	You can install nvm using the command ,
...
1.	Installing bb-cli is simple. Run npm i -g @appblocks/bb-cli
2.	It is recommended to install bb-cli globally (hence the -g flag), if you prefer to install without -g, command might need to be prefixed with npx ( Eg. npx bb login )
![git6](https://user-images.githubusercontent.com/97872852/203756370-557ad93f-4817-4cc7-b7c3-cdbfa65b39cb.gif)
Linux
Start by installing nvm, then node and finally bb-cli
Follow same steps as for windows wsl
Mac
Start by installing nvm, then node and finally bb-cli
Follow same steps as for windows wsl
