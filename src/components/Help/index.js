...
export default function CustomerSupport() {
    ...
    return (
        <div className="max-w-7xl clear-both w-full mt-10">
            ...
            <Link href="mailto:support@appblocks.com" className="text-primary hover:!text-primary focus:!text-primary focus:outline-none inline-flex items-center text-base font-medium">
