    ...
    <nav
      ...
      <div className="navbar__inner">
        <div className="navbar__items">
          ...
          <Logo
            className="navbar__brand hover:text-[#1c1e21]"
            imageClassName="navbar__logo"
            titleClassName="navbar__title"
          />
        ...
        <div className="navbar__items navbar__items--right">
         {!hasSearchNavbarItem && <SearchBar />}
          ...
          {/* <button className="hidden lg:inline-block !px-3 py-1 m-0 border border-solid border-primary rounded-md outline-none focus:outline-none bg-transparent text-gray-dark text-xs font-semibold hover:bg-gray-50 cursor-pointer">Developer Console</button> */}
        </div>
      </div>
